...
from app.exchange.bitvc.errors import error_text
...
class BitVC(object):
    ...
    def assets(self):
        ...
        """
        sign = self.sign({})
        params = {'access_key': self.cfg['key'],
                  'created': sign[1], 'sign': sign[0]}
        req = requests.post(
            self.cfg['base'] + 'accountInfo/get', data=params, timeout=20).json()
    ...
    def list_orders(self, currency):
        ...
        params = {'access_key': self.cfg['key'],
                  'coin_type': currency, 'created': sign[1], 'sign': sign[0]}
        req = requests.post(
            self.cfg['base'] + 'order/list', data=params, timeout=20).json()
    ...
    def order_info(self, currency, order_id):
        ...
        params = {'access_key': self.cfg['key'],
                  'coin_type': currency, 'created': sign[1], 'sign': sign[0]}
        req = requests.post(
            self.cfg['base'] + 'order/' + str(order_id), data=params, timeout=20).json()
    ...
    def order_cancel(self, currency, order_id):
        ...
        params = {'access_key': self.cfg['key'],
                  'coin_type': currency, 'created': sign[1], 'sign': sign[0]}
        req = requests.post(
            self.cfg['base'] + 'cancel/' + str(order_id), data=params, timeout=20).json()
...
class BitVCFuture(object):
    ...
    def balance(self, coin_type):
        ...
        params = {
            'accessKey': self.cfg['key'], 'coinType': coin_type, 'created': sign[1], 'sign': sign[0]}
        req = requests.post(
            self.cfg['futurebase'] + 'balance', data=params, timeout=20).json()
    ...
    def list_orders(self, currency):
        ...
        params = {'access_key': self.cfg['key'],
                  'coin_type': currency, 'created': sign[1], 'sign': sign[0]}
        req = requests.post(
            self.cfg['futurebase'] + 'order/list', data=params, timeout=20).json()
    ...
    def order_info(self, currency, order_id):
        ...
        params = {'access_key': self.cfg['key'],
                  'coin_type': currency, 'created': sign[1], 'sign': sign[0]}
        req = requests.post(
            self.cfg['futurebase'] + 'order/' + str(order_id), data=params, timeout=20).json()
    ...
    def order_cancel(self, currency, order_id):
        ...
        params = {'access_key': self.cfg['key'],
                  'coin_type': currency, 'created': sign[1], 'sign': sign[0]}
        req = requests.post(
            self.cfg['futurebase'] + 'cancel/' + str(order_id), data=params, timeout=20).json()

        return req

    def get_current_bitvc_future_deal_price(self):
        req = requests.get(
            "http://market.bitvc.com/futures/ticker_btc_week.js", timeout=20).json()
        return req
