...
def getTicker(coinType, market):
    if market == COIN_TYPE_CNY:
        if coinType == HUOBI_COIN_TYPE_BTC:
            url = "https://api.huobi.br.com/staticmarket/ticker_btc_json.js"
        else:
            url = "https://api.huobi.br.com/staticmarket/ticker_ltc_json.js"
    elif market == COIN_TYPE_USD:
        if coinType == HUOBI_COIN_TYPE_BTC:
            url = "https://api.huobi.br.com/usdmarket/ticker_btc_json.js"
        else:
